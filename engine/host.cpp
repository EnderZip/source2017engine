...
static ConVar host_competitive_ever_enabled( "host_competitive_ever_enabled", "0", FCVAR_HIDDEN, "Has competitive ever been enabled this run?",  NULL  );
...
ConVar	deathmatch( "deathmatch","0", FCVAR_NOTIFY | FCVAR_HIDDEN, "Running a deathmatch server." );	// 0, 1, or 2
