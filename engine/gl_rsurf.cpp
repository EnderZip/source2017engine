...
static ConVar r_fastzreject( "r_fastzreject", "0", FCVAR_CHEAT, "Activate/deactivates a fast z-setting algorithm to take advantage of hardware with fast z reject. Use -1 to default to hardware settings" );
