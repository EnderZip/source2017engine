...
ConVar snd_surround( "snd_surround_speakers", "-1", FCVAR_CHEAT);
...
ConVar snd_spatialize_roundrobin( "snd_spatialize_roundrobin", "0", FCVAR_CHEAT, "Lowend optimization: if nonzero, spatialize only a fraction of sound channels each frame. 1/2^x of channels will be spatialized per frame." );
/*
============
S_Update
