...
static ConVar net_udp_rcvbuf("net_udp_rcvbuf", NETSTRING(UDP_SO_RCVBUF_SIZE), FCVAR_CHEAT, "Default UDP receive buffer size", true, 8192, true, 128 * 1024);
...
static ConVar ipname("ip", "localhost", FCVAR_CHEAT, "Overrides IP for multihomed hosts");
static ConVar hostport("hostport", NETSTRING(PORT_SERVER), FCVAR_CHEAT, "Host game server port");
static ConVar hostip("hostip", "", FCVAR_CHEAT, "Host game server ip");

static ConVar clientport("clientport", NETSTRING(PORT_CLIENT), FCVAR_CHEAT, "Host game client port");
static ConVar hltvport("tv_port", NETSTRING(PORT_HLTV), FCVAR_CHEAT, "Host SourceTV port");
static ConVar matchmakingport("matchmakingport", NETSTRING(PORT_MATCHMAKING), FCVAR_CHEAT, "Host Matchmaking port");
static ConVar systemlinkport("systemlinkport", NETSTRING(PORT_SYSTEMLINK), FCVAR_CHEAT, "System Link port");
